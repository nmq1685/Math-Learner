...
const SITE_TRANSLATIONS = {
    ...
    'footer_privacy': { vi: 'Chính Sách Bảo Mật', en: 'Privacy Policy', ru: 'Политика конфиденциальности' },
    'footer_terms': { vi: 'Điều Khoản Sử Dụng', en: 'Terms of Use', ru: 'Условия использования' },
    'about_page_title': { vi: 'Về Math Learner', en: 'About Math Learner', ru: 'О Math Learner' },
    'about_hero_p': { vi: 'Sáng kiến cá nhân nhằm giúp trẻ em yêu thích toán học hơn thông qua trò chơi.', en: 'A personal project aimed at making children love math through interactive games.', ru: 'Личный проект, направленный на то, чтобы дети полюбили математику через интерактивные игры.' },
    'mission_title': { vi: 'Tại sao chọn Math Learner?', en: 'Why choose Math Learner?', ru: 'Почему Math Learner?' },
    ...
    'method_title': { vi: 'Tương Tác Nhanh', en: 'Fast Interaction', ru: 'Быстрое взаимодействие' },
    'method_desc': { vi: 'Phản hồi tức thì giúp trẻ nhận biết đúng sai ngay lập tức.', en: 'Instant feedback helps children recognize right or wrong immediately.', ru: 'Мгновенная обратная связь помогает детям сразу понимать результат.' },
    'age_title': { vi: 'Đa Dạng Cấp Độ', en: 'Multiple Levels', ru: 'Множество уровней' },
    'age_desc': { vi: 'Từ cơ bản đến nâng cao, phù hợp với tiến trình học tập của trẻ.', en: 'From basic to advanced, suitable for the child\'s learning progress.', ru: 'От основ до продвинутого уровня, в соответствии с прогрессом ребенка.' },
    'dev_title': { vi: 'An Toàn & Miễn Phí', en: 'Safe & Free', ru: 'Безопасно и бесплатно' },
    'dev_desc': { vi: 'Không quảng cáo, không thu phí, tập trung hoàn toàn vào việc học.', en: 'No ads, no fees, fully focused on learning.', ru: 'Без рекламы и оплаты, полное погружение в учебу.' },
    'about_mission_title': { vi: 'Sứ Mệnh', en: 'Our Mission', ru: 'Наша миссия' },
    'about_mission_desc': { vi: 'Chúng tôi tin rằng học toán không nên là một gánh nặng. Math Learner được tạo ra để biến những con số khô khan trở thành niềm vui.', en: 'We believe learning math shouldn\'t be a burden. Math Learner was created to turn dry numbers into joy.', ru: 'Мы верим, что изучение математики не должно быть бременем. Math Learner был создан для радости.' },
    'about_method_title': { vi: 'Phương Pháp', en: 'Method', ru: 'Методика' },
    'about_method_desc': { vi: 'Kết hợp "Học mà chơi - Chơi mà học", chúng tôi sử dụng màu sắc tươi sáng và âm thanh vui nhộn để kích thích tư duy.', en: 'Combining "Learning through play", we use bright colors and fun sounds to stimulate thinking.', ru: 'Сочетая «учение через игру», мы используем яркие цвета и веселые звуки.' },
    'about_age_title': { vi: 'Mọi Lứa Tuổi', en: 'All Ages', ru: 'Для всех возрастов' },
    'about_age_desc': { vi: 'Từ những phép cộng trừ đơn giản đến các bài toán thách thức hơn, Math Learner đồng hành cùng sự phát triển của trẻ.', en: 'From simple addition to more challenging problems, Math Learner accompanies the child\'s development.', ru: 'От простого сложения до сложных задач, Math Learner сопровождает развитие ребенка.' },
    'author_title': { vi: 'Tác Giả', en: 'Author', ru: 'Автор' },
    'author_desc': { vi: 'Dự án cá nhân này được phát triển bởi Nguyễn Minh Quân (FouZ) với mục đích học tập và chia sẻ kiến thức giáo dục miễn phí.', en: 'This personal project was developed by Nguyễn Minh Quân (FouZ) for learning purposes and to share free educational resources.', ru: 'Этот личный проект был разработан Нгуен Минь Куаном (FouZ) в учебных целях и для обмена бесплатными образовательными ресурсами.' },
    // Privacy Policy
    'privacy_title': { vi: 'Chính Sách Bảo Mật', en: 'Privacy Policy', ru: 'Политика конфиденциальности' },
    'privacy_hero_p': { vi: 'Cam kết bảo vệ sự riêng tư và an toàn cho trẻ em.', en: 'Committed to protecting children\'s privacy and safety.', ru: 'Стремление к защите конфиденциальности и безопасности детей.' },
    'privacy_section1_title': { vi: '1. Thu thập thông tin', en: '1. Information Collection', ru: '1. Сбор информации' },
    'privacy_section1_desc': { vi: 'Math Learner không thu thập bất kỳ thông tin cá nhân nào từ người dùng, đặc biệt là trẻ em. Chúng tôi không yêu cầu đăng ký tài khoản.', en: 'Math Learner does not collect any personal information from users, especially children. We do not require account registration.', ru: 'Math Learner не собирает никакую личную информацию пользователей, особенно детей. Регистрация не требуется.' },
    'privacy_section2_title': { vi: '2. Sử dụng dữ liệu', en: '2. Data Usage', ru: '2. Использование данных' },
    'privacy_section2_desc': { vi: 'Mọi dữ liệu về tiến trình học tập được lưu trữ cục bộ trên trình duyệt của bạn (Local Storage).', en: 'All progress data is stored locally on your browser (Local Storage).', ru: 'Все данные о прогрессе хранятся локально в вашем браузере (Local Storage).' },
    'privacy_section3_title': { vi: '3. Quảng cáo & Bên thứ ba', en: '3. Ads & Third Parties', ru: '3. Реклама и третьи лица' },
    'privacy_section3_desc': { vi: 'Ứng dụng hoàn toàn không có quảng cáo và không tích hợp các bộ theo dõi từ bên thứ ba.', en: 'The app is completely ad-free and does not integrate third-party trackers.', ru: 'Приложение полностью без рекламы и не содержит сторонних трекеров.' },
    'privacy_section4_title': { vi: '4. Liên hệ', en: '4. Contact', ru: '4. Контакты' },
    'privacy_section4_desc': { vi: 'Mọi câu hỏi vui lòng liên hệ qua email: quannm1685@gmail.com.', en: 'Any questions please contact via email: quannm1685@gmail.com.', ru: 'По всем вопросам обращайтесь по электронной почте: quannm1685@gmail.com.' },
    // Terms & Conditions
    'terms_title': { vi: 'Điều Khoản Sử Dụng', en: 'Terms of Use', ru: 'Условия использования' },
    'terms_hero_p': { vi: 'Quy định khi sử dụng nền tảng học tập Math Learner.', en: 'Regulations for using the Math Learner platform.', ru: 'Правила использования платформы Math Learner.' },
    'terms_section1_title': { vi: '1. Chấp nhận điều khoản', en: '1. Acceptance of Terms', ru: '1. Принятие условий' },
    'terms_section1_desc': { vi: 'Bằng cách sử dụng Math Learner, bạn đồng ý tuân thủ các điều khoản này. Ứng dụng là miễn phí.', en: 'By using Math Learner, you agree to comply with these terms. The app is free.', ru: 'Используя Math Learner, вы соглашаетесь с этими условиями. Приложение бесплатно.' },
    'terms_section2_title': { vi: '2. Quyền sở hữu trí tuệ', en: '2. Intellectual Property', ru: '2. Интеллектуальная собственность' },
    'terms_section2_desc': { vi: 'Toàn bộ nội dung thuộc về dự án cá nhân của Nguyễn Minh Quân. Không sao chép khi chưa có sự đồng ý.', en: 'All content belongs to Nguyễn Minh Quân\'s personal project. No copying without consent.', ru: 'Весь контент принадлежит личному проекту Нгуен Минь Куана. Копирование запрещено.' },
    'terms_section3_title': { vi: '3. Giới hạn trách nhiệm', en: '3. Limitation of Liability', ru: '3. Ограничение ответственности' },
    'terms_section3_desc': { vi: 'Chúng tôi không chịu trách nhiệm về bất kỳ sai sót kỹ thuật nào phát sinh trong quá trình sử dụng.', en: 'We are not responsible for any technical errors arising during usage.', ru: 'Мы не несем ответственности за любые технические ошибки, возникшие в процессе использования.' },
    'terms_section4_title': { vi: '4. Thay đổi nội dung', en: '4. Content Changes', ru: '4. Изменение контента' },
    'terms_section4_desc': { vi: 'Chúng tôi có quyền cập nhật hoặc thay đổi ứng dụng bất kỳ lúc nào để cải thiện trải nghiệm.', en: 'We reserve the right to update or change the app at any time to improve experience.', ru: 'Мы оставляем за собой право обновлять или изменять приложение в любое время.' },
